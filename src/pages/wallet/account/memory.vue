        ...
        <div class="sell_nums">
          <div class="sell_titles">
            ...
            <span class="sell_balance">
              余额：{{sellBalance}}bytes &#8776; {{(Number(sellBalance / 1024)).toFixed(2)}} KB
            </span>
          </div>
          <label
            class="sell_inputs"
...
export default {
  ...
  beforeMount () {
    // 头部
    this.pageTitle({ title: '内存', shadown: true });
  },
  methods: {
    ...mapMutations({
